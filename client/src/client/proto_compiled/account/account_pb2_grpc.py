...
from proto import client.src.client.proto_compiled.account.account_pb2 as proto_dot_account__pb2
...
class AccountStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAccount = channel.unary_unary(
                ...
                request_serializer=proto_dot_account__pb2.GetAccountRequest.SerializeToString,
                response_deserializer=proto_dot_account__pb2.GetAccountResponse.FromString,
                )
        ...
        self.DeleteAccount = channel.unary_unary(
                ...
                request_serializer=proto_dot_account__pb2.DeleteAccountRequest.SerializeToString,
                response_deserializer=proto_dot_account__pb2.DeleteAccountResponse.FromString,
                )
...
def add_AccountServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAccount': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAccount,
                    request_deserializer=proto_dot_account__pb2.GetAccountRequest.FromString,
                    response_serializer=proto_dot_account__pb2.GetAccountResponse.SerializeToString,
            ),
            ...
            'DeleteAccount': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=proto_dot_account__pb2.DeleteAccountRequest.FromString,
                    response_serializer=proto_dot_account__pb2.DeleteAccountResponse.SerializeToString,
            ),
...
class Account(object):
    ...
    def GetAccount(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/account.Account/GetAccount',
            proto_dot_account__pb2.GetAccountRequest.SerializeToString,
            proto_dot_account__pb2.GetAccountResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteAccount(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/account.Account/DeleteAccount',
            proto_dot_account__pb2.DeleteAccountRequest.SerializeToString,
            proto_dot_account__pb2.DeleteAccountResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
